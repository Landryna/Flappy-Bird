...
#define LCD_RST_0		HAL_GPIO_WritePin(GPIOA, GPIO_PIN_9, GPIO_PIN_RESET)
#define LCD_RST_1		HAL_GPIO_WritePin(GPIOA, GPIO_PIN_9, GPIO_PIN_SET)

#define LCD_DC_0		HAL_GPIO_WritePin(GPIOC, GPIO_PIN_7, GPIO_PIN_RESET)
#define LCD_DC_1		HAL_GPIO_WritePin(GPIOC, GPIO_PIN_7, GPIO_PIN_SET)

//#define LCD_BL_0		HAL_GPIO_WritePin(GPIOC, GPIO_PIN_3, GPIO_PIN_RESET)
//#define LCD_BL_1		HAL_GPIO_WritePin(GPIOC, GPIO_PIN_3, GPIO_PIN_SET)
